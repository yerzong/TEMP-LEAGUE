...
- [ ] (Más adelante) Code Connect para enlazar componentes de Figma con el código.

> Regla: una vez exista Figma, **Figma es la verdad visual**; este repo lo documenta y lo
> conecta con el producto y el código.
